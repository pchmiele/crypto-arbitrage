...
- Time complexity `O(V*E)` - for very dense graphs (number of currency exchanges (`E`) is equal/close to (`V^2`), for example when there is an exchange between all currencies, it could be close to `O(V^3)`)
